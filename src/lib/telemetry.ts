...
export function classifyRole(cmd: string): string {
  const map: [RegExp, string][] = [
    [/netflow/i, 'Smart Money Netflow'],
    [/dex-trades/i, 'Smart Money DEX Trades'],
    ...
    [/profiler/i, 'Wallet Profiler'],
    [/token\s*info/i, 'Token Info'],
    [/screener/i, 'Token Screener'],
    [/flow-intelligence|token\s*flows/i, 'Token Flows'],
    [/token\s*holders/i, 'Token Holders'],
    [/who-bought-sold/i, 'Buy/Sell Analysis'],
    [/indicators/i, 'Token Indicators'],
    [/ohlcv/i, 'Price Data'],
    [/trade\s*quote/i, 'Trade Quote'],
    [/trade\s*execute/i, 'Trade Execution'],
    [/account/i, 'Account'],
    [/alerts/i, 'Alerts'],
    [/related-wallets/i, 'Related Wallets'],
    [/trace/i, 'Wallet Trace'],
    [/compare/i, 'Wallet Compare'],
    [/transactions/i, 'Transactions'],
    [/historical-balances/i, 'Historical Balances'],
    [/search/i, 'Search'],
    [/perp\s*screener/i, 'Perp Screener'],
    [/perp\s*leaderboard/i, 'Perp Leaderboard'],
    [/perp-positions/i, 'Perp Positions'],
